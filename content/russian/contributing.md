...
Если вы читаете этот текст на github'е, то откройте его на [алгоритмике](https://ru.algorithmica.org/contributing/). Затем нужно нажать на кнопку с карандашом сверху справа.  Откроется интерфейс prose.io, в котором нужно залогиниться через github, после чего можно редактировать markdown-исходник страницы.
